        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav onSelect={this.closeNav} className="mr-auto">
            ...
            <NavDropdown title="אודות הקורס " id="basic-nav-dropdown">
              ...
              <LinkContainerNavLink
                to="/technologiesAreTaught"
                textLink="טכנולוגיות הנלמדות בקורס"
              />
              <LinkContainerNavLink
                to="/courseFormat"
                textLink="זמנים ומתכונת הקורס"
              />
              <LinkContainerNavLink
                to="/projects"
                textLink="פרויקטים ופרויוקטונים"
              />
