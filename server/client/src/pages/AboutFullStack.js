...
function AboutFullStack() {
  ...
  {subTitle:'פיתוח צד שרת . חלק הלוגי, הנמצא "מאחורי" ממשק המשתמש ',subTxt:'הממשק מתקשר עם השרת על מנת לשלוח נתונים(בקשות) בשם הלקוח, לקבל תשובות ולהציגן. בהתחשב בעובדה שישנם לקוחות רבים ניתן להניחח שתכנות בצד שרת עוסק בעיקר בחישוב תשובות, אחסון וטעינת מידע - וכל זאת במהירות המירבית.'}]  
  return (
