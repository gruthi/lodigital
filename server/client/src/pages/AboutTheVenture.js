...
function AboutTheVenture() {
  let txt = [
  {subTitle:'רקע על "לודיגיטל"',subTxt:'המיזם “לודגיטיל" פועל לסייע לתושבי לוד ברכישת השכלה בתחום פיתוח תוכנה. המיזם אינו למטרות רווח ומנוהל בהתנדבות ע"י דוד אליאב ונתן קרסני.'},
  ...
  {subTitle:'',subTxt:'קורס FullStack בנוי בהתאם לצרכי השוק ומאפשר לבוגריו לשמש כמתכנתים בחברות שונות.'}  ]      
  return (
